        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>UI / UX DESIGN</h3>
              <h4>Creating User-Centered Experiences</h4>
              <p>
                Crafting visually engaging and intuitive digital products. From user 
                research to high-fidelity prototypes, I balance function and form.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Leveraging powerful tools to bring design concepts to life. 
                Proficient in industry-leading design and prototyping software.
              </p>
              <h5>Tools & Expertise</h5>
              <div className="what-content-flex">
                <div className="what-tags">Figma</div>
                <div className="what-tags">Photoshop</div>
                <div className="what-tags">Behance</div>
